...
add_set_tests () {
    ...
    sudo cp -r /riaps-x86runtime/env_setup_tests/WeatherMonitor /home/$RIAPSUSER/env_setup_tests/
...
add_eclipse_projects() {
    ...
    sudo cp -r $(pwd)/riaps-apps/apps-vu/DistributedEstimator /home/$RIAPSUSER/riaps_projects/.
    sudo cp -r $(pwd)/riaps-apps/apps-vu/DistributedEstimatorGPIO /home/$RIAPSUSER/riaps_projects/.
    sudo cp -r $(pwd)/riaps-apps/apps-vu/WeatherMonitor /home/$RIAPSUSER/riaps_projects/.
    ...
    sudo cp -r $(pwd)/riaps-pycom/bin/riaps_ctrl.launch /home/$RIAPSUSER/riaps_launch_files/.
    sudo cp -r $(pwd)/riaps-pycom/bin/riaps_deplo.launch /home/$RIAPSUSER/riaps_launch_files/.
    sudo cp -r $(pwd)/riaps-pycom/bin/rpyc_registry.launch /home/$RIAPSUSER/riaps_launch_files/.
